...
class ZigBeeDevice extends MeshDevice {
	...
	_setPollInterval(capabilityId, clusterId, pollInterval) {
		...
		this.log('_setPollInterval', capabilityId, clusterId, pollInterval)
		this._pollIntervals[capabilityId][clusterId] = setInterval(() => {
			this.log('_setPollInterval Interval', capabilityId, clusterId, pollInterval)
	...
	_getCapabilityValue(capabilityId, clusterId) {
		...
		try {
			...
			this.log('try read', capabilityGetObj, cluster)
			return cluster.read(capabilityGetObj.commandId)
				.then(res => {
					this.log(res)
					return this._onReport(capabilityId, capabilityGetObj.clusterId, res)
				})
	...
	_onReport(capabilityId, clusterId, payload) {
		this.log('_onReport', capabilityId, clusterId, payload)
		...
		this.log('setCapabilityValue', capabilityId, parsedPayload)
	...
	_getCapabilityObj(commandType, capabilityId, clusterId) {
		...
		const parser = cluster[`${commandType}Parser`];
